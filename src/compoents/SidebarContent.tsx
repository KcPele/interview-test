...
const SidebarContent: React.FC = () => {
  ...
  return (
    <div className='min-h-[100vh] pr-2 ml-0'>
        ...
        <div className=''>
            <h3 className='pl-[60px] mb-5'>OTHERS 1</h3>
            <ul className=''>
        ...
        <div className=''>
            <h3 className='pl-[60px] mb-5'>OTHERS 2</h3>
            <ul className=''>
        ...
        <div className='lg:ml-[50px] ml-[30px] md:mt-[160px] mt-[120px] w-[100%] md:w-auto flex items-center justify-between'>
